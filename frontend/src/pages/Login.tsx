                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="block w-full rounded-xl border border-white/5 bg-white/5 px-4 py-3 text-white placeholder-gray-500 transition-all focus:border-blue-500/50 focus:bg-white/10 focus:outline-none focus:ring-4 focus:ring-blue-500/10"
                        ...
                        <button
                            type="submit"
                            className="w-full rounded-xl bg-gradient-to-r from-blue-600 to-blue-500 px-4 py-3.5 font-bold text-white shadow-lg shadow-blue-500/20 transition-all hover:scale-[1.02] active:scale-[0.98] hover:shadow-blue-500/40"
                        >
                            Sign In
                        </button>
                    </form>
